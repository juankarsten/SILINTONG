 ...
 * @author ALdY
 */
@WebServlet(name = "EducationCategory", urlPatterns = {"/EducationCategory"})
public class EducationCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet resultSet = db.getEducationCategory();
            ...
            RequestDispatcher view=request.getRequestDispatcher("kategoriedukasi.jsp");

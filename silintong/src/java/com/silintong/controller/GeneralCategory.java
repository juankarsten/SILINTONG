 ...
 * @author ALdY
 */
@WebServlet(name = "GeneralCategory", urlPatterns = {"/GeneralCategory"})
public class GeneralCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet resultSet = db.getGeneralCategory();
            ...
            RequestDispatcher view=request.getRequestDispatcher("kategoriumum.jsp");
